...
class customerClass:
    def __init__(self, root):
        ...
        # -----------------------title---------------------------------
        title = Label(self.root, text="Customer Details", font=("goudy old style", 20), bg="#0f4d7d", fg="white").place(x=50, y=10, width=1000, height=40)
        ...
        # --------------------------row4--------------------------------
        lbl_desc = Label(self.root, text="Address", font=("goudy old style", 15), bg="white").place(x=50, y=200)
        ...
        self.customerTable.heading("desc", text="Address")
