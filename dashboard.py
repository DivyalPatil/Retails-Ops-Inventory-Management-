...
class IMS:
    def __init__(self,root):
       ...
       #title
       self.icon_title = PhotoImage(file="C:/Users/divya/OneDrive/Desktop/MiniPro/images/logo1.png")
       ...
       #clock
       self.lbl_clock=Label(self.root,text="Welcome to Our Website",font=("times new roman",15),bg="#4d636d",fg="white")
       ...
       lbl_menu=Label(LeftMenu,text="Menu",font=("times new roman",26),bg="#010c48",fg="white").pack(side=TOP,fill=X)
      
    #customer button
       image = Image.open("images/customer.png")
       resized_image = image.resize((20, 20), Image.ANTIALIAS)  # Adjust dimensions as needed
       self.icon_customer = ImageTk.PhotoImage(resized_image)
       btn_customer = Button(LeftMenu, text="Customer", image=self.icon_customer,command=self.customer, compound=LEFT, padx=16, anchor="w",
                             font=("times new roman", 18, "bold"), bg="white", fg="black", bd=3, cursor="hand2")
    ...
    #sales button
       ...
       btn_sales = Button(LeftMenu, text="Sales", image=self.icon_s,command=self.sales, compound=LEFT, padx=16, anchor="w",
                             font=("times new roman", 18, "bold"), bg="white", fg="black", bd=3, cursor="hand2")
    ...
    #bills button 
       ...
       btn_bills = Button(LeftMenu, text="Bills", image=self.icon_bills,command=self.bills, compound=LEFT, padx=16, anchor="w",
                             font=("times new roman", 18, "bold"), bg="white", fg="black", bd=3, cursor="hand2")
    ...
    #exit button   
       ...
       btn_exit= Button(LeftMenu, text="Exit", image=self.icon_exit,command=self.exit, compound=LEFT, padx=16, anchor="w",
                             font=("times new roman", 18, "bold"), bg="white", fg="black", bd=3, cursor="hand2")
      ...
      #content
       ...
       customer_frame.place(x=220, y=120, width=250, height=120)
       ...
       resized_image = image.resize((70, 70), Image.ANTIALIAS)
       ...
       lbl_customer_text = Label(text_frame, text="Customer", font=("goudy old style", 14, "bold"), bg="white", fg="black")
       lbl_customer_text.pack(expand=True, padx=10, pady=5)

        # Product Outer frame
       product_frame = Frame(self.root, bd=5, relief=RIDGE)
       product_frame.place(x=480, y=120, width=250, height=120)
       ...
       resized_image_prod = image_prod.resize((70, 70), Image.ANTIALIAS)
       ...
       lbl_product_text = Label(text_frame_prod, text="Product", font=("goudy old style", 15, "bold"), bg="white", fg="black")
       lbl_product_text.pack(expand=True, padx=10, pady=5)

        # Sales Outer frame
        # Sales Frame
       sales_frame = Frame(self.root, bd=5, relief=RIDGE)
       sales_frame.place(x=740, y=120, width=250, height=120)
       ...
       resized_image_sales = image_sales.resize((70, 70), Image.ANTIALIAS)
       ...
       lbl_sales_text = Label(text_frame_sales, text="Sales",font=("goudy old style", 15, "bold"), bg="white", fg="black")
      ...
      # resized_image_order = image_order.resize((70, 70), Image.ANTIALIAS)
      ...
      # lbl_order_text.pack(expand=True, padx=10, pady=5)
       ...
       category_frame.place(x=1000, y=120, width=250, height=120)
       ...
       resized_image_category = image_category.resize((70, 70), Image.ANTIALIAS)
       ...
       lbl_category_text = Label(text_frame_category, text="Category", font=("goudy old style", 14, "bold"), bg="white", fg="black")
...
#create first table
    ...
    # Load and resize the image with LANCZOS
        image = Image.open("C:/Users/divya/OneDrive/Desktop/MiniPro/images/dicebox.png")
...
# Label to display the image
        ...
        lbl_table_title = Label(table_frame, text="Highest Selling Product", font=("goudy old style", 16, "bold"), fg="black")
        lbl_table_title.grid(row=0, column=0, columnspan=3, padx=49, pady=5, sticky="ew")
        ...
        for i, (product_id, product_name, order_qty) in enumerate(recommended_products[['product_id', 'product_name', 'order_qty']].values):
            lbl_product = Label(table_frame, text=f"{i+1}. {product_name} - {order_qty}", font=("goudy old style", 15), fg="black")
...
# Navy blue line separator
    ...
    # Calculate the height of the table up to the footer
        ...
        another_table_frame.place(x=770, y=250, width=480, height=400)
...
# Label to display the image
        ...
        lbl_another_table_title.grid(row=0, column=0, columnspan=3, padx=49, pady=5, sticky="ew")
